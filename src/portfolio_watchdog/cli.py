...
def main() -> None:
    ...
    if args.command == "install-schedule":
        ...
        return
    if args.command in {"render-report-pdf", "send-report-document", "send-message-file", "complete-report", "sync-dashboard", "merge-news-risks", "sync-news-risks"} and not args.path:
